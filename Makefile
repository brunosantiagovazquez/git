...
FUZZ_OBJS =
FUZZ_PROGRAMS =
LIB_H = $(CHECK_PATH)/check_role.h $(API_PATH)/db_constants.h $(API_PATH)/generic_list.h $(API_PATH)/gitpro_data_api.h $(VALIDATE_PATH)/role_validate.h $(FUNCTIONS)/role_functions.h $(VALIDATE_PATH)/task_validate.h $(VALIDATE_PATH)/v_codes.h $(FUNCTIONS)/task_functions.h
LIB_OBJS = $(CHECK_PATH)/check_role.o $(API_PATH)/generic_list.o $(API_PATH)/gitpro_data_api.o $(API_PATH)/sql_helper.o $(VALIDATE_PATH)/role_validate.o $(FUNCTIONS)/role_functions.o $(VALIDATE_PATH)/task_validate.o $(FUNCTIONS)/task_functions.o
PROGRAM_OBJS =
PROGRAMS =
EXCLUDED_PROGRAMS =
SCRIPT_PERL =
